...
public class FuncionWS {
    ...
    public void eliminarFuncion(@WebParam(name = "id") int id,@WebParam(name = "id_mod") int id_mod) throws Exception {
        String url = this.urlBase + "/" + FUNCION_RESOURCE + "/" + id+"-"+id_mod;;
