...
public class CuponDAOImpl extends BaseDAOImpl<Cupon> implements ICuponDAO{
    ...
    protected Cupon mapearModelo(ResultSet rs) throws SQLException {
        ...
        usuario.setId(rs.getInt("creado_por"));
        cupon.setCreadoPor(usuario);
        return cupon;
    }
